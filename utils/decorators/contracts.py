"""!
This module contains decorators to check pre- and postconditions to a function and throw a ValueError if they're not fulfilled.
"""
...
def precondition(
    description: str, c_args: Tuple[str, ...], condition: Callable[..., bool], /
) -> Callable:
    """!
